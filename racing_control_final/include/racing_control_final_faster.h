...
private:
    ...
    // ==================== 共用参数 ====================
    float lineSpeed_ = 2.0;
    float follow_p_ = 0.12;
    int avoidBottom_ = 200;
    ...
    float turn_center_coeff_ = 1.0f;

    // ==================== Session 5: 转向相关 ====================
    // 第一次变道参数
    float turn_angle_left_ = 12.0;
    float turn_angle_right_ = 12.0;
    float turn_duration_left_ = 4.3;
    float turn_duration_right_ = 5.6;
    float correct_duration_left_ = 4.0;
    float correct_duration_right_ = 4.7;
    
    // 第二次变道参数（超车/回到车道）
    float turn2_angle_left_ = 14.0;
    float turn2_angle_right_ = 12.0;
    float turn2_duration_left_ = 9.4;
    float turn2_duration_right_ = 10.3;
    float correct2_duration_left_ = 7.7;
    float correct2_duration_right_ = 11.3;
    ...
    float final_sprint_speed_ = 0.4f;
